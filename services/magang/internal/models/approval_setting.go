...
// ApprovalMapping is the code-based approval configuration per section and approval type.
type ApprovalMapping struct {
	...
	Seq1         string    `gorm:"column:seq_1;type:varchar(50)" json:"seq_1"`
	Seq2         string    `gorm:"column:seq_2;type:varchar(50)" json:"seq_2"`
	Seq3         string    `gorm:"column:seq_3;type:varchar(50)" json:"seq_3"`
	Seq4         string    `gorm:"column:seq_4;type:varchar(50)" json:"seq_4"`
